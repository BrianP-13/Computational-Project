...
"file_path/"
## Genes in top/bottom 10% 6-4PP regions
T10_64_genes<-read.csv(file = "file_path/Top 10perc 64PP - genes.csv")
B10_64_genes<-read.csv(file = "file_path/IP64/Bottom 10perc 64PP - genes.csv")

## Genes in top/bottom 10% CPD regions
T10_CPD_genes<-read.csv(file = "file_path/CPD/Top 10perc CPD - genes.csv")
B10_CPD_genes<-read.csv(file = "file_path/CPD/Bottom 10perc CPD - genes.csv")

## Genes in top/bottom 10% RankDiff regions
T10_Diff_genes<-read.csv(file = "file_path/RankDiff/Top 10perc RankDiff - genes.csv")
B10_Diff_genes<-read.csv(file = "file_path/RankDiff/Bottom 10perc RankDiff - genes.csv")

# List of genes in top and bottom regions, file name components
...
File_names_T10<-c("T10_64_genes","T10_CPD_genes","T10_Diff_genes")
File_names_B10<-c("B10_64_genes","B10_CPD_genes","B10_Diff_genes")
