...
## Genes in top/bottom 10% 6-4PP ratio regions
T10_64_genes<-read.csv(file = "file_path/Genes_in_T10_64PP_ratio.csv")
B10_64_genes<-read.csv(file = "file_path/Genes_in_B10_64PP_ratio.csv")

## Genes in top/bottom 10% CPD ratio regions
T10_CPD_genes<-read.csv(file = "file_path/Genes_in_T10_CPD_ratio.csv")
B10_CPD_genes<-read.csv(file = "file_path/Genes_in_B10_CPD_ratio.csv")
...
Path_out<-c("IP64/","CPD/")
File_names_T10<-c("T10_64_ratio_genes","T10_CPD_ratio_genes")
File_names_B10<-c("B10_64_ratio_genes","B10_CPD_ratio_genes")
